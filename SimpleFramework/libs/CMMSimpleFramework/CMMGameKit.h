...
@protocol CMMGameKitHandlerProtocol <NSObject>
...
@interface CMMGameKitHandler : NSObject<CMMGameKitHandlerProtocol>{
...
-(void)gameKitHandlerMatch:(CMMGameKitHandlerMatch *)gameKitHandler_ didFailWithError:(NSError *)error_;
...
-(void)gameKitHandlerSession:(CMMGameKitHandlerSession *)gameKitHandler_ didReceiveConnectionRequestFromPeer:(NSString *)peerID_;
-(void)gameKitHandlerSession:(CMMGameKitHandlerSession *)gameKitHandler_ connectionWithPeerFailed:(NSString *)peerID_ withError:(NSError *)error_;
-(void)gameKitHandlerSession:(CMMGameKitHandlerSession *)gameKitHandler_ didFailWithError:(NSError *)error_;
@end
